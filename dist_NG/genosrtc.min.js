...
var i8 = ($) => {
  ...
  p8 = ($, J) => {
    ...
    if ((assertBoolean(q.lowS, 'lowS'), assertBoolean(q.prehash, 'prehash'), q.format !== void 0))
      i8(q.format)
    return q
  }
function R0($, J) {
...
function gQ($, J = {}) {
  ...
  function L(_W, O, M) {
    const { x: B, y: Y } = O.toAffine(),
      D = Q.toBytes(B)
    if ((assertBoolean(M, 'isCompressed'), M)) {
      N()
      const C = !Q.isOdd(Y)
      return o(g$(C), D)
  ...
  class I {
    ...
    toBytes(W = !0) {
      return assertBoolean(W, 'isCompressed'), this.assertValidity(), K(I, this, W);
    }
    toHex(W = !0) {
